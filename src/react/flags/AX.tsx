...
const AX = ({ size = 15, width = 21, height = 15, ...props }: Props) => {
  if (size !== height) {
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 21 15" {...props}>
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <path fill="url(#prefix__c)" d="M0 9h6v6h3V9h12V6H9V0H6v6H0z" />
        <path fill="url(#prefix__d)" d="M0 8h7v7h1V8h13V7H8V0H7v7H0z" />
      </g>
    </svg>
  );
};
